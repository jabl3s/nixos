...
(for now max gain lower lower output vol should effectively noise cancel - allout) (sound to some exp divide by fixed val factor vs superimposed back noise program), since noisetorch is expecting pulseaudio and im going alsa it wont suffice.    
.  
.    
