...
(for now max gain lower lower output vol should effectively noise cancel) (sound to some exp divide by fixed val factor) -ish, since noise torch is expecting pulseaudio and im going alsa    
.  
.    
