...
N.B. that the .../by-id/...(uuid-mac-/dev/sdX) part in the dir value will change on drive every re-insert for /dev/sdX, but not the (uuid-mac-/dev/sdX) bit, didnt see the suffix in the template, oops.    
